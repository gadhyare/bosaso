    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-md-4  ">
            <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
                <?php if (isset($_GET['a']) && $_GET['a'] == 'edit') : ?>
                    ...
                    <?php foreach ((array) $empupdate as $empupdatedo) : ?>
                        <div class="card p-0 rounded-0">
                            <div class="card-header unique-color-dark text-white text-center p-1 rounded-0"> <?=$op->lang("updatethe selected expenses");?> </div>
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="exptypeid"> <?=$op->lang("expenses type");?> </label>
                                ...
                                <div class="form-group">
                                    <label for="expensess_date"> <?=$op->lang("date");?> </label>
                                ...
                                <div class="form-group">
                                    <label for="expensess_amount"> <?=$op->lang("amount");?> </label>
                                ...
                                <div class="form-group">
                                    <label for="expensess_note"> <?=$op->lang("details");?> </label>
                ...
                <?php else : ?>
                    <div class="card p-0 rounded-0">
                        <div class="card-header unique-color-dark text-white text-center p-1 rounded-0"> <?=$op->lang("add");?>  <?=$op->lang("expenses");?>  </div>
                        <div class="card-body">
                            <div class="form-group">
                                <label for="exptypeid">  <?=$op->lang("expenses type");?>  </label>
                                <select name="exptypeid" id="exptypeid" class="form-control p-0 alert-info rounded-0">
        ...
        <div class="col-xs-12 col-md-8  ">
            <div class="card p-0 rounded-0">
                <div class="card-header unique-color-dark text-white text-center p-1 rounded-0"> <?=$op->lang("expenses list");?>  </div>
                <div class="card-body">
                    <table class="table table-striped table-bordered" id="myTable">
                        <thead class="border">
                            <th class="p-1  border text-center alert-info text-dark"> <?=$op->lang("no");?>  </th>
                            <th class="p-1  border text-center alert-info text-dark"> <?=$op->lang("expenses type");?></th>
