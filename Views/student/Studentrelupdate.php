    ...
    <div class="container col-xs-12 col-sm-12 col-md-10 m-auto ">
        <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
            <div class="container text-left">
                <input type="submit" name="update_rel" value="<?= $op->lang("update"); ?>" id="submit" class="btn danger-color-dark   rounded-0 text-white    mb-3  py-2 px-3">
                    ...
                    <div class="card-header accord-header unique-color-dark text-center    rounded-0" role="tab" id="headingOne">
                        <h5 class="mb-0 ">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                <?= $op->lang("Close information for the student"); ?>
                            </a>
                        </h5>
                    </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group input-group-sm p-1 m-0">
                                            ...
                                            <input type="text" required="required" name="rel_name" value="<?php echo $row['rel_name']; ?>" id="rel_name" class="form-control  p-1  rounded-0" placeholder="<?= $op->lang("name"); ?> ">
                                        </div>
                                        <div class="form-group input-group-sm p-1 m-0">
                                    ...
                                    <td>
                                        <div class="form-group input-group-sm p-1 m-0">
                                            ...
                                            <input type="text" required="required" name="rel_Address" value="<?php echo $row['rel_Address']; ?>" id="rel_Address" class="form-control  p-1  rounded-0" placeholder="<?= $op->lang("address"); ?>">
                                        </div>
                                        <div class="form-group input-group-sm p-1 m-0">
                                            <label> <?= $op->lang("email"); ?> </label>
                                            <input type="text" required="required" name="rel_email" value="<?php echo $row['rel_email']; ?>" id="rel_email" class="form-control  p-1  rounded-0" placeholder="<?= $op->lang("email"); ?>">
                                        </div>
                                        <div class="form-group input-group-sm p-1 m-0">
                                            <label><?= $op->lang("phones"); ?></label>
                                            <input type="text" required="required" name="rel_phones" value="<?php echo $row['rel_phones']; ?>" id="rel_phones" class="form-control  p-1  rounded-0" placeholder="<?= $op->lang("phones"); ?>">
                                        </div>
                                    </td>
                                </tr>
                            </table>
