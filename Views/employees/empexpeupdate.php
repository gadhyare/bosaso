  <?php
    /**
     * fileName:تعديل  خبرات  سابقة للموظف
     */
    ?>
      ...
      <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
          ...
          <div class="container col-xs-12 col-md-6  m-auto bg-white text-right z-depth-0">
              <div class="card  z-depth-0 border  rounded-0 ">
                  <div class="card-header py-2 px-1 text-center border-0 rounded-0 p-1 unique-color-dark text-white "> <?=$op->lang("update");?> <?=$op->lang("the employee's previous experience");?></div>
