  ...
  <?php foreach ((array) $viewmodel as $items) : ?>
      <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
          ...
          <a href="<?php echo ROOT_URL; ?>/employees/empqualadd/<?php echo $id; ?>" class="btn danger-color-dark text-white px-3 py-2 float-left"> <?=$op->lang("go back");?></a>
              ...
              <div class="card  z-depth-0 border  rounded-0 ">
                  ...
                  <div class="card-body px-2 border  rounded-0 ">
                      <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
                          ...
                          <a href="<?php echo ROOT_URL; ?>/employees/empinfo" class="btn danger-color-dark text-white px-3 py-1  float-left"> <?=$op->lang("go back");?> </a>
                      </form>
                  </div>
              </div>
          </div>
